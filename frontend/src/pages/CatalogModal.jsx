				...
				>
					<div className="p-8 space-y-8 flex-1">
						...
						<section className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm relative overflow-hidden">
							<h3 className="text-sm font-black text-gray-900 mb-4 uppercase tracking-widest flex items-center gap-2">
								<span className="bg-blue-600 text-white p-1 rounded">01</span>{" "}
								Essential Fields
							</h3>
						...
						<section className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
							<h3 className="text-sm font-black text-gray-900 mb-4 uppercase tracking-widest flex items-center gap-2">
								<span className="bg-gray-400 text-white p-1 rounded">02</span>{" "}
								Important Fields
							</h3>
							<div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
								<InputField
								...
								<InputField
									label="Call Number"
									value={catalogData.call_number}
									field="call_number"
									placeholder="QA76.76.C65"
									onCatalogDataChange={onCatalogDataChange}
								/>
								<div className="md:col-span-2">
									<InputField
										label="Subject Headings"
										value={catalogData.subject_keywords}
						...
						<section className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm mb-4">
							<h3 className="text-sm font-black text-gray-900 mb-4 uppercase tracking-widest flex items-center gap-2">
								<span className="bg-teal-500 text-white p-1 rounded">03</span>{" "}
								Electronic Resource Specifics
							</h3>
							<div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4">
								<SelectField
									...
									options={[
										...
										{
											value: "Library subscription required",
					...
					<div className="bg-white border-t border-gray-100 px-8 py-5 flex justify-between items-center shrink-0 shadow-[0_-4px_10px_rgba(0,0,0,0.02)] sticky bottom-0 z-20">
						<div className="text-xs font-bold text-gray-400 flex items-center gap-2">
							<span className="text-red-500 text-lg">★</span> Required Fields
							for Cataloging record
						</div>
						<div className="flex space-x-3">
							<button
								type="button"
								onClick={onClose}
								className="px-6 py-2.5 text-sm font-black text-gray-500 hover:text-gray-900 transition-colors tracking-widest cursor-pointer"
							>
								Discard
							</button>
							<button
								type="submit"
								className="px-8 py-2.5 bg-primary text-white text-sm font-black rounded-xl  cursor-pointer tracking-widest"
							>
								Catalog
							</button>
						</div>
