    ...
    def login(self, email="biruk11011@gmail.com", password="Biruk@0115439"):
        ...
        try:
            ...
            response = self.session.post(
                f"{self.base_url}/authn/login", json=login_data, headers=headers
            )
    ...
    def get_workflow_items(self):
        ...
        try:
            ...
            response = self.session.get(
                f"{self.base_url}/workflow/workflowitems", headers=headers
            )
    ...
    def approve_item(self, item_id):
        ...
        try:
            ...
            if response.status_code in [200, 204]:
                ...
                print(
                    f"     ❌ Failed to approve item {item_id}: {response.status_code}"
                )
                return False
