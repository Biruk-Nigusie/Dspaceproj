#!/usr/bin/env python3
"""
DSpace Amharic Item Seeding Script
Seeds 3 items for each collection with Amharic metadata using the existing DSpace client
"""
...
def main():
    ...
    print("\n" + "="*60)
    print("DSpace Amharic Item Seeding Script")
    print("="*60 + "\n")
    ...
    total_success += seed_collection(client, "Serial (Journal)", COLLECTIONS['serial'], SERIAL_ITEMS)
    ...
    print("="*60)
    print(f"\nTotal items successfully submitted: {total_success}/9")
